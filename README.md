...
- In finance, asset prices are typically modeled as log-normally distributed because returns are multiplicative and prices must remain positive, making the normal distribution unsuitable for price-level modeling.
